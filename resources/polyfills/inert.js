// This is a customized version of https://github.com/WICG/inert.
// The automatic injection of styles was removed in order to comply with our CSP.
// Styles are included in `assets/scss/elements/_base.scss`.
 ...
 * @return {Boolean}
 * @api public
 * @source https://github.com/necolas/dom-matches/blob/2.0.0/index.js
 */
 ...
 *
 * @source https://github.com/WICG/inert/blob/v1.1.6/src/inert.js
 */
(function(document) {
// Convenience function for converting NodeLists.
    ...
    class InertRoot {
        ...
        _makeSubtreeUnfocusable(startNode) {
            ...
            if (contains(startNode, activeElement) && activeElement.blur) {
                activeElement.blur();
            }
        }
    ...
    function addInertStyle(node) {
        // Was removed because of incompatibility with our CSP.
    }
